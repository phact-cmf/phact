...
По-умолчанию все перечисления условий в **filter** и **exclude** объединяются через *AND*. 
Необходимости в применении данного метода нет, он присутсвует для "полноты картины".
